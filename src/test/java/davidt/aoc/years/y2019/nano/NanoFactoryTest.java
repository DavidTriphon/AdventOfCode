...
import static davidt.aoc.years.y2019.nano.NanoFactory.*;
...
class NanoFactoryTest
{
   ...
   {
      return new NanoFactory(ReaderUtil.parseFileToList(
         NanoFactoryTest.class.getResource(filename), Recipe::fromString
      ));
   }
}
