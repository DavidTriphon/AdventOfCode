...
{
   private static final String FILE_LOC_PREFIX = "input/10B/";
   ...
   private static void testAsteroidMap(
      String fileLoc,
   ...
   {
      return AsteroidMap.fromString(ReaderUtil.getFileString(
         Test10B.class.getResource(FILE_LOC_PREFIX + fileLoc + FILE_LOC_SUFFIX)
      ));
   }
}
