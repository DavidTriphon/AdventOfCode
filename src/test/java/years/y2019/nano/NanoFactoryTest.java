...
import static years.y2019.nano.NanoFactory.*;


class NanoFactoryTest
{
   private static final String FILE_LOC_PREFIX =
      ReaderUtil.TEST_RESOURCES_LOCATION + "years/y2019/nano/";
   ...
   {
      return new NanoFactory(
         ReaderUtil.parseFileToList(getFullFilename(filename), Recipe::fromString));
   }
