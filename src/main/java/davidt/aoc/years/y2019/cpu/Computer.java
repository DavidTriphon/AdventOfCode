...
public class Computer
{
   ...
   public static Integer[] getMemoryFromFile(URL fileLoc) throws IOException
   {
      return ReaderUtil.parseFileToList(fileLoc, ",", Integer::parseInt).toArray(new Integer[0]);
   }
}
