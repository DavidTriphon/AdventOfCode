package davidt.aoc.years.y2019.nbody;
...
import static davidt.aoc.util.MathUtil.*;
...
public class NBody
{
   ...
   private final ArrayList <Body> _bodies = new ArrayList <>();
   ...
   public static NBody fromString(String nbodyString) throws IOException
   {
      ...
      for (String line : nbodyString.split("\n"))
      {
         nBody.addBody(Body.fromString(line.trim()));
      }
