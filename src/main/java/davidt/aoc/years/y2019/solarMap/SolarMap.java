package davidt.aoc.years.y2019.solarMap;
...
{
   private final HashMap <String, String>           _orbits;
   private final HashMap <String, HashSet <String>> _connections = new HashMap <>();
   private final HashMap <String, Integer>          _levels      = new HashMap <>();
   
   
   public SolarMap(Map <String, String> orbitMap)
   {
      // copy orbits davidt.aoc.map
